<template>
	<view>
		...
		<view class="toolbar" @touchend.stop="format" :style="'bottom: ' + (isIOS ? keyboardHeight : 0) + 'px'">
			...
			<i :class="'iconfont icon-text_color ' + (formats.color === fontColor ? 'ql-active' : '')" data-name="color" :data-value="fontColor" @tap="open"></i>
		...
		<view class="view_editor">
			<button class="sumbereditor" @tap="store">确 认</button>
		</view>
	</view>
</template>
